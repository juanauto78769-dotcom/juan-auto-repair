...
/**
 * Small inline icon set. Only icons reused across multiple components live
 * here — single-use icons (the service grid, FAQ, etc.) stay inline in the
 * component that renders them so each component reads top to bottom without
 * jumping to a shared file for a one-off shape.
 */
